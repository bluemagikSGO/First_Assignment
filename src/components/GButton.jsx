  ...
  return (
    <div className="flex gap-3">
      <button className="cursor-pointer">
        <div className="flex max-w-48 h-8 px-3 gap-2 rounded-xl items-center justify-center bg-black text-white dark:text-black dark:bg-white sm:h-14">
      ...
      <button className="cursor-pointer">
        <div className="flex max-w-48 h-8 px-3 gap-2 rounded-xl items-center justify-center bg-black text-white dark:text-black dark:bg-white sm:gap-3 sm:h-14">
